...
class PvaReadDemo implements ChannelRequester, MonitorRequester
{
    ...
    PvaReadDemo(final String name) throws Exception
    {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        new PvaReadDemo("ramp");
        new PvaReadDemo("saw");
        new PvaReadDemo("demo:circle:x"); // Make sure the IOC is running.
